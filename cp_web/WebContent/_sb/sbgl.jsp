	...
	<div>
		...
		<div class="dlist" style="margin-top: 20px;">
			<table id="dgrid" cellspacing="0" cellpadding="0">
				<thead>
					<tr>
						<th field="equid" width="100" align="center">设备编号(名称)</th>
						<th field="equtype" width="60" align="center">设备类型</th>
						<th field="warningclass" width="80" align="center">告警类型</th>
						<th field="warninggrade" width="80" align="center">告警等级</th>
						<th field="warningstate" width="80" align="center">告警状态</th>
						<th field="warningsourcename" width="100" align="center">告警源名称</th>
						<th field="warningsourceip" width="120" align="center">告警源地址</th>
						<th field="warningcount" width="80" align="center">累计次数</th>
						<th field="ifreparing" width="80" align="center">维修状态</th>
						<th field="refreshtime" width="150" align="center">监测时间</th>
					</tr>
				</thead>
			</table>
		</div>
